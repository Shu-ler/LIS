...
Процедура Инициализировать(Контейнер, ЗагружаемыеТипы, ИсключаемыеТипы, Обработчики, ПолноеИмяПервогоЗагружаемогоОбъектаМетаданных = Неопределено, СоответствиеСсылок = Неопределено) Экспорт
