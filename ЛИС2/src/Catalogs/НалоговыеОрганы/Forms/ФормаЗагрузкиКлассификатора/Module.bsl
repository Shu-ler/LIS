...
// Функция проверяет корректность каталога и наличие файлов
// SOUN1.DBF, SOUN_V.DBF в выбранном каталоге
...
Процедура ИмпортироватьСправочникиСервер(ПараметрыИмпорта, ТекстСообщения)
	...
	ЭлектронныйДокументооборотСКонтролирующимиОрганамиКлиентСервер.ДобавитьРазделительПути(Каталог);
